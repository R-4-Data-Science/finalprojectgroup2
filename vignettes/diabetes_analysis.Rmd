...
We run forward selection allowing multiple promising paths. We set `delta = 4` to keep models within 4 AIC units of the best child at each step.
...
We filter the forest to find models within 4 AIC units of the minimum (`Delta = 4`) with average stability at least 0.4 (`tau = 0.4`).

```{r plausible}
plausible <- plausible_models(forest, stab, Delta = 4, tau = 0.4)
